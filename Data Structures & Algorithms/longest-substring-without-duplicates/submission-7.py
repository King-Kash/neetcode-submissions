...
if yes then 
    ...
    move the left pointer to index + 1, the substring should be truncated to sub[index+1:], the current length should be updated
else:
    append the char to the subtring
    increase curr_count
    update max_count if curr_count is larger
