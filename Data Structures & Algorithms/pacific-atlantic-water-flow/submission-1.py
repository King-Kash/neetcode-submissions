...
'''
This is O(M * N) because every cell is visited at most a constant number of times. 
It is significantly faster than the O((M * N)^2) naive approach because it avoids the 
"Mountain Peak Problem" by STARTING AT THE SINKS AND MOVING TOWARDS THE SOURCES.
'''
